...
if ( !file_exists(substr(dirname( __FILE__ ), 0,-strlen($current_dir) ) . '/202-config/connect.php') ) {
	
	require_once(substr(dirname( __FILE__ ), 0,-strlen($current_dir) ) . '/202-config/connect.php');
