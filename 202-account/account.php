...
<div class="row account">
	...
	<div class="col-xs-8">
		<form class="form-horizontal" style="padding-top:0px;" role="form" method="post" action="">
		<input type="hidden" name="update_account_curren cy" value="1" />
		<input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>" />
		<div class="form-group">
...
<div class="row account">
	...
	<div class="col-xs-4">
		<div class="panel panel-default account_left">
			<div class="panel-body">
			    If you want to use special mods and paid features built into Prosper202, sign up <a href="http://my.tracking202.com/api/customers/register">here</a>, fill out yout billing information, receive and insert your API key here.
			</div>
		</div>
	</div>
	<div class="col-xs-8">
