...
include_once(substr(dirname( __FILE__ ), 0,-strlen($current_dir) ) . '/202-config/clickserver_api_management.php');
...
<div class="row account">
	<div class="col-xs-12">
		<div class="row">
			<div class="col-xs-4">
				<h6><span><img src="<?php echo get_absolute_url();?>202-img/icons/integrations/jvzoo.png"></span> JVZIPN Integration <?php showHelp("jvzoo"); ?></h6>
			</div>
			<div class="col-xs-8">
...
<div class="row account">
	<div class="col-xs-12">
		<div class="row">
			<div class="col-xs-4">
				<h6><span><img src="<?php echo get_absolute_url();?>202-img/icons/integrations/zaxaa.png"></span> ZPN Integration <?php showHelp("zaxaa"); ?></h6>
			</div>
			<div class="col-xs-8">
