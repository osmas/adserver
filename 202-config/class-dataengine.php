...
class DataEngine
{
    ...
    function __construct()
    {
        ...
        $this->mysql['user_id'] = 1;//self::$db->real_escape_string($_SESSION['user_id']);
...
AND 202_dataengine.click_time <= " . $mysql['to'] . $click_filtered . "
...
((SUM(2st.income)-SUM(2st.cost))/SUM(2st.cost)*100 ) as roi FROM 202_dataengine as 2st " . $click_filtered['join'] . " WHERE user_id='" . $this->mysql['user_id'] . "' AND click_time >= " . $mysql['from'] . " AND click_time <= " . $mysql['to'] . $click_filtered['filter'] . " group by" . $groupby . $this->sortOrder('sort_breakdown_time_order asc');
...
SUM(2st.cost)/sum(clicks) AS cpc,
(SUM(2st.income)-SUM(2st.cost)) AS net,
((SUM(2st.income)-SUM(2st.cost))/SUM(2st.cost)*100 ) as roi FROM 202_dataengine as 2st " . $click_filtered['join'] . " WHERE user_id='" . $this->mysql['user_id'] . "' AND click_time >= " . $mysql['from'] . " AND click_time <= " . $mysql['to'] . $click_filtered['filter'] . " group by HOUR(FROM_UNIXTIME(click_time)) " . $this->sortOrder('breakdown asc');
...
WHERE
    2st.user_id = ".$this->mysql['user_id']."
