...
if (is_installed() == true) {
	...
	if (preg_match('/-(10\..+)-MariaDB/i', $mysqlversion, $match)) {
	    ...
	    $dbwording="MariaDB >= 10.1";
	    if ((version_compare($mysqlversion, '10.0') < 0)) {
	        $version_error['mysqlversion'] = 'Prosper202 requires MariaDB 10.0, or newer.';
	    }
	}
	else{
	    $dbwording="MySQL >= 5.5";
...
info_top(); ?>
	...
	<?php } else { ?>
	<a href="<?php echo get_absolute_url();?>202-config/get_apikey.php" class="btn btn-lg btn-block btn-p202" target="_blank" id="202_lb_install_btn">Install Prosper202 Now <span class="glyphicon glyphicon-chevron-right"></span></a>
	<?php } ?>	

	</div>
	<script type="text/javascript">
<!--
var lb_url = "http://202.redirexit.com/tracking202/redirect/dl.php?t202id=61275&t202kw=req-screen-lb";
