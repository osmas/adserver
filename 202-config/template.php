  		...
  		<div class="col-xs-9">
	  		<nav class="navbar navbar-default" role="navigation">
				<ul class="nav navbar-nav">
				    ...
				    <li <?php if ($navigation[1] == '202-tv') { echo 'class="active";'; } ?>><a href="<?php echo get_absolute_url();?>202-tv/" id="Tv202Page" ><span class="fui-video" aria-hidden="true"></span> TV202 </a> </li> 
				    <li <?php if ($navigation[1] == '202-resources') { echo 'class="active";'; } ?>><a href="<?php echo get_absolute_url();?>202-resources/" id="ResourcesPage"><span class="fui-star-2"></span> Featured Resources </a></li>
				</ul>
