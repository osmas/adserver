...
<div id="area_<?php echo $count; ?>">
	...
	<div class="campaign_select">
		<div class="form-group">
			...
			<div class="col-xs-6">
				<select class="form-control input-sm campaign_select_input" name="aff_campaign_id_<?php echo $count; ?>" id="aff_campaign_id_<?php echo $count; ?>">					
	...
	<div class="rotator_select" style="display:none">
		<div class="form-group">
			...
			<div class="col-xs-6">
				<select class="form-control input-sm rotator_select_input" name="rotator_id_<?php echo $count; ?>" id="rotator_id_<?php echo $count; ?>">					
				<option value="0"> -- </option> 	
				<?php 	$mysql['user_id'] = $db->real_escape_string($_SESSION['user_id']);
	...
	$(document).ready(function() {
		...
		$('.rotator_select_input').select2();
		$('.campaign_select_input').select2();
	});
	</script>
</div>
