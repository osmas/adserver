...
//file_get_contents('http://localhost/tracking202/redirect/dl.php?t202id=6377&t202kw=ping');
//print_r($_POST);
//print_r($_SERVER);
//die();
...
//print_r($_SERVER);
//$_SERVER=[];
//print_r(json_encode(serialize($_SERVER)));
...
//ok we have the main data, now insert this row
$click_sql = "INSERT INTO  202_clicks_counter SET click_id=DEFAULT";
$click_result = $db->query($click_sql) or die(mysql_error($db));
echo $db->insert_id;
echo $click_sql;
