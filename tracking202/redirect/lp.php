...
if ($cloaking_on == true) {
	...
	$cloaking_site_url = $strProtocol.'://'.$_SERVER['SERVER_NAME'] . dirname($_SERVER['PHP_SELF']).'/lpc.php?lpip=' . $tracker_row['landing_page_id_public'];
...
$redirect_site_url = replaceTrackerPlaceholders($db, $redirect_site_url,$mysql['click_id'],$mysql);
