...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($_POST['display_ads'] == true) {
		$file = getCurlValue($_FILES['file']['tmp_name'],'image/jpeg',$_FILES['file']['name']);
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, "http://my.tracking202.com/api/v2/premium-p202/upload-ads/".$user_row['install_hash']."/".$user_row['p202_customer_api_key']."");
...
template_top('Ads Setup',NULL,NULL,NULL);  ?>
		...
		<div class="tabbable-panel">
				<div class="tabbable-line">
					<ul class="nav nav-tabs ">
						<li class="active">
							<a href="#tab_default_1" data-toggle="tab">Text Ad Setup (optional)</a>
						</li>
						<li>
							<a href="#tab_default_2" data-toggle="tab">Display Ads (optional)</a>
						</li>
					</ul>
					<div class="tab-content">
						...
						<div class="tab-pane" id="tab_default_2">
							<div class="row">
									<div class="col-xs-5">
										<h6>Display Ads (optional) <?php showHelp("step5"); ?></h6>
									</div>
									<div class="col-xs-7">
										
									</div>
									<div class="col-xs-12">
										<small>Here is where you upload your display ad creative. You can select files one by one or just drop files in this page, to start upload.</small>
										<br>
										<h4>The Display Ads Uploader Is An Advanced Feature For Paid Prosper202 Marketing Cloud Clients. </h4>
										<a href="#" onclick="Intercom('showNewMessage', 'Please Tell Me More About The Display Ads Uploader')"  class="btn btn-primary btn-lg btn-block">Click Here To Learn More</a>
											<?php 
//Initiate curl
$ch = curl_init();
...
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
// Set the url
curl_setopt($ch, CURLOPT_URL, 'http://my.tracking202.com/feed/displayads/');
// Execute
$result = curl_exec($ch);
curl_close($ch);
