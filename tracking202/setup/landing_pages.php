...
<div class="row">
	<div class="col-xs-7">
		...
		<form method="post" action="<?php if ($delete_success == true) { echo $_SERVER['REDIRECT_URL']; }?>" class="form-horizontal" role="form" style="margin:15px 0px;">
           ...
           <?php /* ?>  <div class="form-group" style="margin-bottom: 10px;">
          ...
          <?php */ ?>
				<div id="leave_behind_div" class="form-group <?php if($error['landing_page_url']) echo "has-error";?>" style="margin-bottom: 10px;">
