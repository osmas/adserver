			...
			<?php
				...
				while ( $row = $result->fetch_array (MYSQLI_ASSOC) ) {
					...
					if ($rule_result->num_rows == 0) {
						...
						?>
							<li><?php echo $rule_row['rule_name']." - ".$criteria;?> (<a href="#" id="rule_details" data-id="<?php echo $rule_row['id'];?>">Details</a>)</li>
						<?php }
						echo "</ul>";
						?>
...
<div class="row">
	<div class="col-xs-7" style="margin-top:15px;">
		...
		<span class="infotext">Network ranges in redirector can be specified as: <br><b>Wildcard format:</b> 1.2.3.* <br><b>CIDR format:</b> 1.2.3/24 OR 1.2.3.4/255.255.255.0 or <br><b>Start-End IP format:</b> 1.2.3.0-1.2.3.255</span>
	</div>
...
<div id="rule_values_modal" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" id="rotator_details_body">
            </div>
