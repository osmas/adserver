...
//this is alittle different
	...
	echo 	$click_row['click_id'] . "\t" .
			dollar_format($click_row['income'], $click_row['user_account_currency']) . "\t" . 
